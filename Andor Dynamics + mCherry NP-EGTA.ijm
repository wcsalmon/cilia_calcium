...
roiManager("Save", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017 - region/NP-EGTA 2017 analysis ROI Logs/"+title+".zip");
roiManager("Multi Measure");
saveAs("Results", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017 - region/NP-EGTA 2017 analysis mCherry/"+title+"mCh.csv");
...
roiManager("Show All");
roiManager("Save", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017 - region/NP-EGTA 2017 analysis ROI Logs/"+title+"GECO.zip");
roiManager("Multi Measure");
saveAs("Results", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017 - region/NP-EGTA 2017 analysis/"+title+".xls");
selectWindow("Log")
saveAs("Text", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017 - region/NP-EGTA 2017 analysis ROI Logs/"+title+"_log.txt");
close();
close();