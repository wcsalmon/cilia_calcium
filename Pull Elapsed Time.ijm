...
run("Slice Remover", "first=76 last=600 increment=1");
...
selectWindow("Log")
saveAs("Text", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017 - region/NP-EGTA 2017 analysis et files/"+title+" et.txt");
close();
//print("Complete.");