//EDIT lines 14 & 45
//Line 14: If there are multiple cilia per FOV, change the letter prior to running.  
//If only 1 cilium, comment out.
...
roiManager("Save", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017/ATP 2017 analysis ROI Logs/"+title+".zip");
roiManager("Multi Measure");
saveAs("Results", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017/ATP 2017 analysis mCherry/"+title+"_mCh.csv");
...
roiManager("Show All");
roiManager("Save", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017/ATP 2017 analysis ROI Logs/"+title+"GECO.zip");
roiManager("Multi Measure");
saveAs("Results", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017/ATP 2017 analysis/"+title+".xls");
selectWindow("Log")
saveAs("Text", "/Users/wsalmon/Google Drive/Thesis/Analysis/Calcium dynamics/Raw Measurements 2017/ATP 2017 analysis ROI Logs/"+title+"_log.txt");
close();
